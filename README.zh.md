...
│   │   ├── 210-bugbot-autofix.mdc # BugBot PR 回复
│   │   ├── 310-commit-msg.mdc  # 提交信息助手
...
- **210-bugbot-autofix.mdc**: 回复 BugBot PR
- **300-security-audit.mdc**: 综合安全标准、最佳实践、合规性清单
- **310-commit-msg.mdc**: 提交信息助手
- **400-reactive-storage.mdc**: React 状态和上下文模式
